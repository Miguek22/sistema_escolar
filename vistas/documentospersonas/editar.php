        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/documentospersonas/controller.documentospersonas.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="rela_persona_id" id="combo_persona" required>
                        ...
                        <?php foreach ($personas as $persona): ?>
                            <option value=<?php echo $persona['persona_id'];?>
                            <?php
                            if($persona['persona_id'] == $documento['rela_persona_id']){
                                echo "selected";
                            }
                            ?>> <?php echo $persona['ndni_persona']." ".$persona['cnombres_persona']." ".$persona['capellidos_persona']; ?> </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label for="perfil">
                    <img src="<?php echo $absolute_include."storage/documentos/".$documento['ccarpeta_documento']."/".$documento['cimg_documento'];?>" style="width:120px; height:120px;" id="vista_previa">
                    </label>
                    <label id="info">Click en la imagen para subir foto</label>
                    
                    <input hidden type="file" id="perfil" class="form-control" name="cimg_documento" accept="image/png, image/jpeg">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="rela_tipodocumento_id" required>
                        ...
                        <?php foreach ($tiposdoc as $tipodoc): ?>
                            <option value=<?php echo $tipodoc['tipodocumento_id'];?>
                            <?php 
                            if($tipodoc['tipodocumento_id'] == $documento['rela_tipodocumento_id']){
                                echo "selected";
                            }
                            ?>> <?php echo $tipodoc['cdescripcion_tipodocumento']; ?> </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                                ...
                                onClick = "window.location.href = '<?php echo $carpeta_trabajo;?>/controladores/documentospersonas/controller.documentospersonas.php';"
                                value=Volver>
                        </div>
...
<script>
    ...
    $("#reset").click(function(){
        $('#vista_previa').attr("src","<?php echo $documento['ccarpeta_documento']."/".$documento['cimg_documento'];?>");
    });
