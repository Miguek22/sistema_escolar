...
<div class="card-columns">
  ...
  <div class="card bg-light">
    <div class="card-body text-center">
      <p class="card-text"><a href="<?php echo $carpeta_trabajo;?>/controladores/docents/controller.docentes.php">Docentes</a></p>
    </div>
  </div>
  <div class="card bg-light">
    <div class="card-body text-center">
...
<div class="card-columns">
  ...
  <div class="card bg-light">
    <div class="card-body text-center">
      <p class="card-text"><a href="<?php echo $carpeta_trabajo;?>/controladores/etapasescolares/controller.etapasescolares.php">Etapas Escolares</a></p>
    </div>
...
<div class="card-columns">
  <div class="card bg-light">
    <div class="card-body text-center">
      <p class="card-text"><a href="<?php echo $carpeta_trabajo;?>/controladores/documentospersonas/controller.documentospersonas.php">Documentos Personales</a></p>
    </div>
  </div>
  <div class="card bg-light">
    <div class="card-body text-center">
